...
Two more pieces exist off `main`, both uncommitted until September 2026:

- [`feb-2025-backend-tests`](https://github.com/bryan-lolordo/gradually_ai/tree/feb-2025-backend-tests)
  holds one day's work, **February 28, 2025**: logging and a registration
  endpoint in `api.py`, a run script, and an API test suite.
- [`march-2025-frontend`](https://github.com/bryan-lolordo/gradually_ai/tree/march-2025-frontend)
  holds the work from **February 28 to March 2, 2025**. It restructures
  the backend into packages, drops `crewai_dev/`, and adds a React + Vite
  + TypeScript `frontend/`. That is the last thing built as Gradually
  before it became lifeOS.
